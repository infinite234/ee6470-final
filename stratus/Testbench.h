...
public:
	...
	sc_out < bool >  o_rst;
#ifndef NATIVE_SYSTEMC
	cynw_p2p< sc_dt::sc_uint<24> >::base_out o_r;
	cynw_p2p< sc_dt::sc_uint<24> >::base_out o_i;
  cynw_p2p< sc_dt::sc_uint<24> >::base_in i_result_r;
  cynw_p2p< sc_dt::sc_uint<24> >::base_in i_result_i;
#else
	sc_fifo_out< sc_dt::sc_uint<24> > o_r;
	sc_fifo_in< sc_dt::sc_uint<24> > o_i;
  sc_fifo_in< sc_dt::sc_uint<24> > i_result_i;
  sc_fifo_in< sc_dt::sc_uint<24> > i_result_r;
#endif
