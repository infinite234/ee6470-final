...
define_hls_module lstm ../lstm.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config lstm BASIC
define_hls_config lstm DPA       --dpopt_auto=op,expr
...
#define_sim_config V_BASIC "lstm RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.3 The Verilog simulation for HLS config "DPA". 
#define_sim_config V_DPA "lstm RTL_V DPA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
